...
(function() {
    ...
    angular.module('gmc-pay.controller').controller('ActiveGmcpayStep1Ctrl', ['$scope', 'buyerRestService',

        function ActiveGmcpayStep1Ctrl($scope, buyerRestService) {
            ...
            $scope.sendVerificationEmail = function() {
                buyerRestService.sendVerificationEmail('activeGMCPay')
